export const aboutText = {
    ...
    describe: {
      ...
      ko: "안녕하세요, 저는 빠르게 성장하고 실행력 있게 움직이는 프론트엔드 개발자 Raina입니다. 다양한 프로젝트를 직접 기획하고 구현하며, 문제 해결과 사용자 경험을 중심으로 코드를 짭니다. 현재는 Next.js, TypeScript, TailwindCSS를 활용한 웹 개발과 Node.js + PostgreSQL 백엔드까지 풀스택 역량을 키우고 있어요. 최근에는 모바일 개발을 위해 React Native도 공부 중입니다.",
    },
  };
